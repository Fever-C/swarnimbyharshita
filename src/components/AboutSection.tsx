      ...
      <div className="container-custom">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="mb-8">
              Established in {brandInfo.foundedYear}, our journey began with a simple vision: 
              to create clothing that stands the test of time in both quality and design.
            </p>
          ...
          <div className="order-1 md:order-2">
            <div className="aspect-square max-w-md mx-auto md:ml-auto relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=800&auto=format&fit=crop&q=80&ixlib=rb-4.0.3" 
