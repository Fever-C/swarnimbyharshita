...
const Hero = () => {
  return <section className="relative w-full h-[80vh] md:h-[85vh] overflow-hidden">
      <div className="absolute inset-0 bg-brand-light">
        ...
        backgroundImage: "url('https://images.unsplash.com/photo-1580465446361-8aae5321885c?w=800&auto=format&fit=crop&q=80&ixlib=rb-4.0.3')"
      }}>
          <div className="absolute inset-0 bg-black/20"></div>
        </div>
      </div>

      <div className="relative h-full container-custom flex flex-col justify-center bg-red-400">
        <div className="max-w-xl animate-fade-up">
          <h1 className="text-4xl md:text-6xl tracking-tight mb-4 drop-shadow-sm font-bold text-yellow-200">
